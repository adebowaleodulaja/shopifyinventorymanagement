...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Product p SET p.totalOrdered = :totalordered where p.id = :id")
    void updateTotalOrder(@Param(value = "totalordered") int quantityOrdered, @Param(value = "id") long productId);
}
